      ...
      <form action={saveRecipeAction} className="stack">
        ...
        <section className="filter-section">
          <div className="section-heading">
            ...
            <p className="field-hint">
              Keep a reusable name, notes, and export shape with the search recipe.
            </p>
          </div>
        ...
        <section className="filter-section">
          <div className="section-heading">
            ...
            <p className="field-hint">
              These saved defaults prefill company search and keep repeated runs consistent.
            </p>
          </div>
          <div className="field-grid">
            <div className="field">
        ...
        <section className="filter-section">
          <div className="section-heading">
            ...
            <p className="field-hint">
              Save the people-search shape you reuse most often so Phase 3 starts with the right defaults.
            </p>
          </div>
          <div className="field-grid">
            <div className="field">
