...
export const retrievalRunRecordSchema = z.object({
  ...
  reusedItems: z.number().int().nonnegative().default(0),
  dedupedItems: z.number().int().nonnegative().default(0),
  reusedVerifiedItems: z.number().int().nonnegative().default(0),
  reusedUnusableItems: z.number().int().nonnegative().default(0),
  newlyEnrichedItems: z.number().int().nonnegative().default(0),
  apolloRequestedItems: z.number().int().nonnegative().default(0),
